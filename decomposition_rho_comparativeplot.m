...
for i=1:4
    legendstring{i}=sprintf('rho=%.2f',rhos(i));
end
%*****************************
...
plot(s, decompose_spread(:,1,1,1),'LineWidth',1);
    hold on
plot(s, decompose_spread(:,1,1,2),'LineWidth',1);
hold on 
plot(s, decompose_spread(:,1,1,3),'LineWidth',1);
 hold on 
plot(s, decompose_spread(:,1,1,4),'LineWidth',1);
hold on
...
plot(s, decompose_spread(:,1,2,1),'LineWidth',1);
    hold on
plot(s, decompose_spread(:,1,2,2),'LineWidth',1);
hold on 
plot(s, decompose_spread(:,1,2,3),'LineWidth',1);
 hold on 
plot(s, decompose_spread(:,1,2,4),'LineWidth',1);
hold on
%text(-0.32,0.4,'5-year','rotation',90,'FontSize',10,'Units','normalized','FontWeight','Bold');  
    ylim([0,200]);
...
%legend(legendstring);
 subplot(3,3,3)
plot(s, decompose_spread(:,1,3,1),'LineWidth',1);
    hold on
plot(s, decompose_spread(:,1,3,2),'LineWidth',1);
hold on 
plot(s, decompose_spread(:,1,3,3),'LineWidth',1);
 hold on 
plot(s, decompose_spread(:,1,3,4),'LineWidth',1);
...
%low leverage 10 year
 subplot(3,3,4)
plot(s, decompose_spread(:,2,1,1),'LineWidth',1);
    hold on
plot(s, decompose_spread(:,2,1,2),'LineWidth',1);
hold on 
plot(s, decompose_spread(:,2,1,3),'LineWidth',1);
 hold on 
plot(s, decompose_spread(:,2,1,4),'LineWidth',1);
hold on
...
%legend(legendstring);
   ...
   %medium leverage 10 year 
    ...
    subplot(3,3,5)
plot(s, decompose_spread(:,2,2,1),'LineWidth',1);
    hold on
plot(s, decompose_spread(:,2,2,2),'LineWidth',1);
hold on 
plot(s, decompose_spread(:,2,2,3),'LineWidth',1);
 hold on 
plot(s, decompose_spread(:,2,2,4),'LineWidth',1);
hold on
%text(-0.32,0.4,'5-year','rotation',90,'FontSize',10,'Units','normalized','FontWeight','Bold');  
    ylim([0,200]);
...
plot(s, decompose_spread(:,2,3,1),'LineWidth',1);
    hold on
plot(s, decompose_spread(:,2,3,2),'LineWidth',1);
hold on 
plot(s, decompose_spread(:,2,3,3),'LineWidth',1);
 hold on 
plot(s, decompose_spread(:,2,3,4),'LineWidth',1);
hold on
%text(-0.32,0.4,'5-year','rotation',90,'FontSize',10,'Units','normalized','FontWeight','Bold');  
    ylim([0,200]);
...
plot(s, decompose_spread(:,3,1,1),'LineWidth',1);
    hold on
plot(s, decompose_spread(:,3,1,2),'LineWidth',1);
hold on 
plot(s, decompose_spread(:,3,1,3),'LineWidth',1);
 hold on 
plot(s, decompose_spread(:,3,1,4),'LineWidth',1);
hold on
...
plot(s, decompose_spread(:,3,2,1),'LineWidth',1);
    hold on
plot(s, decompose_spread(:,3,2,2),'LineWidth',1);
hold on 
plot(s, decompose_spread(:,3,2,3),'LineWidth',1);
 hold on 
plot(s, decompose_spread(:,3,2,4),'LineWidth',1);
hold on
%text(-0.32,0.4,'5-year','rotation',90,'FontSize',10,'Units','normalized','FontWeight','Bold');  
    ylim([0,200]);
...
plot(s, decompose_spread(:,3,3,1),'LineWidth',1);
    hold on
plot(s, decompose_spread(:,3,3,2),'LineWidth',1);
hold on 
plot(s, decompose_spread(:,3,3,3),'LineWidth',1);
 hold on 
plot(s, decompose_spread(:,3,3,4),'LineWidth',1);
hold on
%text(-0.32,0.4,'5-year','rotation',90,'FontSize',10,'Units','normalized','FontWeight','Bold');  
    ylim([0,200]);
xlabel('share of tree A');
...
subplot(3,3,1)
%low leverage short term 
 plot(s, decompose_stochastic(:,1,1,1),'LineWidth',1,'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,1,1,2),'LineWidth',1,'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,1,1,3),'LineWidth',1,'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,1,1,4),'LineWidth',1,'LineWidth',1);
 ylim([0,200]);
...
ylabel('bps');
 ...
 plot(s, decompose_stochastic(:,1,2,1),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,1,2,2),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,1,2,3),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,1,2,4),'LineWidth',1);
...
ylim([0,200]);
 subplot(3,3,3)
    ...
    plot(s, decompose_stochastic(:,1,3,1),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,1,3,2),'LineWidth',1');
 hold on 
 plot(s, decompose_stochastic(:,1,3,3),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,1,3,4),'LineWidth',1);
...
%low leverage 10 year
 subplot(3,3,4)
   plot(s, decompose_stochastic(:,2,1,1),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,2,1,2),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,2,1,3),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,2,1,4),'LineWidth',1);
...
ylabel('bps');
   %medium leverage 10 year 
    ...
    subplot(3,3,5)
 plot(s, decompose_stochastic(:,2,2,1),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,2,2,2),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,2,2,3),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,2,2,4),'LineWidth',1);
...
ylabel('bps');
 ...
 plot(s, decompose_stochastic(:,2,3,1),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,2,3,2),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,2,3,3),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,2,3,4),'LineWidth',1);
...
ylabel('bps');
 ...
 subplot(3,3,7)
      ...
      plot(s, decompose_stochastic(:,3,1,1),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,3,1,2),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,3,1,3),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,3,1,4),'LineWidth',1);
...
%medium leverage perp 
 ...
 subplot(3,3,8)
  plot(s, decompose_stochastic(:,3,2,1),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,3,2,2),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,3,2,3),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,3,2,4),'LineWidth',1);
...
ylabel('bps');
 ...
 subplot(3,3,9)
      ...
      plot(s, decompose_stochastic(:,3,3,1),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,3,3,2),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,3,3,3),'LineWidth',1);
 hold on 
 plot(s, decompose_stochastic(:,3,3,4),'LineWidth',1);
